<script>
	$(document).ready( function() {
	    ...
	    $('#med').click( function() {
			...
			$.ajax({
				type: "POST",
				url: "application/views/claims/ajax/medicines/incoming.php",
				data: 'id_med='+id_med+'&count='+count+'&consigment='+consigment+'&data='+data+'&price='+price,
				success: function(result) {
		            window.location.href = "?option=details&id="+id_med;
...
<div class="col-lg-12">
	<ul class="nav nav-tabs">
		<li role="presentation" class="active"><a href="?option=details&id=<?=$_GET['id'];?>">Приход</a></li>
		<li role="presentation" ><a href="?option=expense&id=<?=$_GET['id'];?>">Расход</a></li>
