<script>
	$(document).ready( function() {
	    ...
	    $('#nazn1').click( function() {
	    	...
	    	$.ajax({
	    		type: "POST",
	    		url: "application/views/claims/ajax/costs/exp1.php",
	    		data: 'patient='+patient+'&count='+count+'&price='+price+'&data='+data+'&id_med='+id_med,
...
<div class="col-lg-12">
	<ul class="nav nav-tabs">
		<li role="presentation" ><a href="?option=cincoming&id=<?=$_GET['id'];?>">Приход</a></li>
		<li role="presentation" class="active"><a href="?option=expcost&id=<?=$_GET['id'];?>">Расход</a></li>
		<li class="pull pull-right">
			...
			<button class="btn btn-sm btn-primary" data-toggle="modal" data-target=".myModal3">
				<span class="glyphicon glyphicon-plus-sign"></span> Назначить расходный материал
			</button>
		</li>
	</ul>
	<hr>
	...
	<table class="table table-condensed">
		...
		?>
			<tr align="center">
				...
				<td><a href="?option=editpersonal&id=<?=$expences[$i]->id_doctor; ?>"><?=getUserName($expences[$i]->id_doctor); ?></a></td>
        ...
        <div class="col-lg-12">
	        <form action="" class="form" role="form">
	        	<div class="form-group">
	        		...
	        		<input type="text" class="input-sm form-control" value="<?=$cost; ?>" disabled>
